...
WebUI.verifyElementText(findTestObject('Complete Footer Object/Page_diagnostics/About Link'), 'About')

WebUI.verifyElementClickable(findTestObject('Complete Footer Object/Page_diagnostics/About Link'))

WebUI.click(findTestObject('Complete Footer Object/Page_diagnostics/a_Accept Cookies'))

WebUI.click(findTestObject('Complete Footer Object/Page_diagnostics/About Link'))
