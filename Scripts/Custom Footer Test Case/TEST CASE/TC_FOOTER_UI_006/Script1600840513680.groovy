...
WebUI.waitForElementVisible(findTestObject('Complete Footer Object/Page_diagnostics/SOCIAL Title'), 0)

WebUI.verifyElementText(findTestObject('Complete Footer Object/Page_diagnostics/SOCIAL Title'), 'SOCIAL')
