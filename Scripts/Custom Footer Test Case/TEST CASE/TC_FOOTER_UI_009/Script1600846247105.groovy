...
WebUI.verifyElementText(findTestObject('Complete Footer Object/Page_diagnostics/Privacy Policy Link'), 'Privacy Policy')

WebUI.verifyElementClickable(findTestObject('Complete Footer Object/Page_diagnostics/Privacy Policy Link'))

WebUI.click(findTestObject('Complete Footer Object/Page_diagnostics/a_Accept Cookies'))

WebUI.click(findTestObject('Complete Footer Object/Page_diagnostics/Privacy Policy Link'))
