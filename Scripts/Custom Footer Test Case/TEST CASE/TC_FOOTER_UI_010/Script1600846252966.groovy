...
WebUI.verifyElementText(findTestObject('Complete Footer Object/Page_diagnostics/Terms of Service Link'), 'Terms of Service')

WebUI.verifyElementClickable(findTestObject('Complete Footer Object/Page_diagnostics/Terms of Service Link'))

WebUI.click(findTestObject('Complete Footer Object/Page_diagnostics/a_Accept Cookies'))

WebUI.click(findTestObject('Complete Footer Object/Page_diagnostics/Terms of Service Link'))
