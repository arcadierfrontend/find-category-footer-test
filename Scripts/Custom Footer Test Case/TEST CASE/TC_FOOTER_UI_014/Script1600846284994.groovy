...
WebUI.verifyElementText(findTestObject('Complete Footer Object/Page_diagnostics/Linkedin Link'), 'Linkedin')

WebUI.verifyElementClickable(findTestObject('Complete Footer Object/Page_diagnostics/Linkedin Link'))

WebUI.click(findTestObject('Complete Footer Object/Page_diagnostics/a_Accept Cookies'))

WebUI.click(findTestObject('Complete Footer Object/Page_diagnostics/Linkedin Link'))
